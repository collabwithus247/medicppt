...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.AjaxCommands.prototype.viewsShowMore = function (ajax, response) {
    ...
    var visibleRowsSelector = response.options.visible_rows || '.visible_rows';
    ...
    if (effect.showEffect === 'scroll_fadeToggle' || effect.showEffect === 'scrollToggle') {
      ...
      // Update the visible rows object
      if ($(visibleRowsSelector).length){
        $(visibleRowsSelector).html('').html(oldItems + newItems);
      }
