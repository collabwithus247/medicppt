...
class ShowMore extends SqlBase {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    // Option to specify the visible_rows, which is a jquery object that can be 
    // added to the views header / footer to create an updating counter of visible rows 
    // when using the result summary for example.
    $form['advance']['visible_rows'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Visible Rows jquery selector'),
      '#description' => $this->t('jQuery object to update the total amount of rows visible. Useful when trying to get a result summary that updates after each load of content. For example <strong><code>Showing <span class="visible_rows">@end</span> of @total Results</code></strong>. Default is <strong><code>".visible_rows"</code></strong>.'),
      '#default_value' => $this->options['advance']['visible_rows'],
    ];
